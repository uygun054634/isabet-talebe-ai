...
# --- SAYFA YAPILANDIRMASI & 500 MB SINIRI ---
st.set_page_config(
...
# --- VERİTABANI SİMÜLASYONU (Kayıtlı Kişiler ve Admin Takibi) ---
...
# --- İSABET YURDU KESİN BİLGİ BANKASI ---
YURT_HAFIZASI = """
Sen sadece İsabet Yurdu'nun resmi yapay zeka asistanı olan 'Talebe AI'sın.
Üslubun İslam ahlakına uygun, edepli, hürmetkar ve Müslüman bir ağızla olmalıdır. Selamla başlar, dualar kullanırsın.
Sana İsabet Yurdu bünyesindeki hocalar sorulduğunda şu bilgileri eksiksiz aktaracaksın:
- Yurt Müdürü: Fatih Uzun Hoca / Yurt Muhasebe: Fatih Meral Hoca / Yurt Anaokulu: Mehmet Kemal Okçu Hoca
- Sınıf Mesulleri: 5.sınıf Nurullah Arif Yaman, 6.sınıf Mikail Akça, 7.sınıf Eyyüp Ergen, 8.sınıf Bedirhan Karaağaçlı
- Dini Dersler: Seviye 1 Şuayb Erim, Seviye 2 (1.Grup) Bedirhan Karaağaçlı, Seviye 2 (2.Grup) Mikail Akça, Seviye 3 Eyyüp Ergen
"""
...
# --- GİRİŞ / KAYIT EKRANI (SADECE E-POSTA, AD SOYAD VE ANAHTAR KOD) ---
if not st.session_state.logged_in:
    ...
    with login_tab:
        ...
        if st.button("Sisteme Giriş Yap"):
            user = next((u for u in st.session_state.users_db if u["email"] == login_email and u["key"] == login_key), None)
            if user:
                st.session_state.logged_in = True
                st.session_state.current_user = user
                
                # Karşılama mesajı protokolü
                if user["fullname"] == "Ah